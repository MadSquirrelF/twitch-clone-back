				...
				<Body className='max-w-2xl mx-auto p-6 bg-slate-50'>
					<Section className='text-center mb-8'>
						...
						<Text className='text-base text-black'>
							Спасибо за регистрацию в Twitch Clone 2! Чтобы подтвердить свой адрес электронной почты, пожалуйста, перейдите по следующей ссылке:
						</Text>
						<Link href={verificationLink} className='inline-flex justify-center items-center rounded-full text-sm font-medium text-white bg-[#9047ff] px-5 py-2'>
							Подтвердить почту
						</Link>
					</Section>
