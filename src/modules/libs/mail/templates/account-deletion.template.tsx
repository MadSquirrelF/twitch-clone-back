		        ...
		        <Body className='max-w-2xl mx-auto p-6 bg-slate-50'>
					<Section className="text-center">
						...
						<Text className="text-base text-black mt-2">
							Ваш аккаунт был полностью стерт из базы данных TwitchClone. Все ваши данные и информация были удалены безвозвратно.
						</Text>
					</Section>
					...
					<Section className="bg-white text-black text-center rounded-lg shadow-md p-6 mb-4">
						...
						<Link
							href={registerLink}
							className="inline-flex justify-center items-center rounded-md mt-2 text-sm font-medium text-white bg-[#9047ff] px-5 py-2 rounded-full"
						>
							Зарегистрироваться на TwitchClone
						</Link>
					</Section>
